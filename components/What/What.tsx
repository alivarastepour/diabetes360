    ...
    <>
      <div className={`${titltNeon.className} ${styles["what-wrapper"]}`}>
        ...
        <div className={styles["what-content"]}>
          ...
          condition in which the body's immune system mistakenly attacks and
          destroys the insulin-producing beta cells in the pancreas. Type 2
          ...
          doesn't use insulin properly (insulin resistance), and over time, the
          pancreas may not produce enough insulin. This leads to elevated blood
          sugar levels.
        </div>
